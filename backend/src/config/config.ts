...
const POSTGRES_DATABASE =
  process.env.POSTGRES_DATABASE || 'credential_provider';
...
const ACCESS_TOKEN_SECRET =
  process.env.ACCESS_TOKEN_SECRET || 'wrongAccessSecret';
const ACCESS_TOKEN_PRIVATE_KEY =
  process.env.ACCESS_TOKEN_PRIVATE_KEY || 'wrongAccessPrivateKey';
const ACCESS_TOKEN_PUBLIC_KEY =
  process.env.ACCESS_TOKEN_PUBLIC_KEY || 'wrongAccessPublicKey';
const REFRESH_TOKEN_SECRET =
  process.env.REFRESH_TOKEN_SECRET || 'wrongRefreshSecret';
const REFRESH_TOKEN_PRIVATE_KEY =
  process.env.REFRESH_TOKEN_PRIVATE_KEY || 'wrongRefreshPrivateKey';
const REFRESH_TOKEN_PUBLIC_KEY =
  process.env.REFRESH_TOKEN_PUBLIC_KEY || 'wrongRefreshPublicKey';
